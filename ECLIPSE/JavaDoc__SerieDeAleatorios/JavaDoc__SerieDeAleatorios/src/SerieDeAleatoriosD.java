...
public class SerieDeAleatoriosD {
	 ...
	 * 
	 * @param numeroItems El parámetro numeroItems define el número de elementos que
	...
	/**
	 * 
	 * Método que devuelve el número de ítems (números aleatorios) existentes en la
	 * serie
	 * 
